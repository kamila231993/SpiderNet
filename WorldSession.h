...
public:
    ...
    void SendAuthResponse(uint8 code, bool shortForm, uint32 queuePos = 0, uint32 waitTime = 0);
...
private:
    ...
    bool _skipQueue;
    time_t m_queueStartTime = 0;        // timpul când a intrat în coadă
    uint32 m_estimatedQueueTime = 0;    // timp estimativ în secunde
    uint32 _accountId;
